...
% Font Size
\newcommand\PHD@ptsize{11pt} %Set Default Size as 11
...
\DeclareOption{draft}{\PassOptionsToClass{\CurrentOption}{book}
  ...
  \ClassWarning{PhDThesisPSnPDF}{Draft is ON. Don't forget to turn it
    ...
    if you prefer the \cite{} classic draft mode. To tweak options see
    `preamble.tex'}}%
...
\ifxetex
  ...
  \newfontfamily\Fontify[Path = .]{Fontify-Regular}
\else
  % default: pdfLaTeX
...
\if@print
  ...
  \hypersetup{
    ...
    citecolor=blue,
    anchorcolor=black,
    % backref=page,%https://github.com/Wookai/paper-tips-and-tricks#back-references
  }
  \ifsetCustomMargin
  ...
  \else
    \ifsetDVI
      ...
      \RequirePackage[dvips,paper=\PHD@papersize,hmarginratio=1:1,
        vmarginratio=1:1,scale=0.76,bindingoffset=5mm]{geometry}
    \else
...
% ********************************* backpage *********************************
% The backpage environment makes sure the backpage gets its
% own page, centered
...
\newenvironment{resume_fr}{
\cleardoublepage
\setsinglecolumn
\chapter*{\centering \Large Resum\'{e} des Travaux de Thèse}
\thispagestyle{empty}
}
...
% \makenomenclature
% \renewcommand{\nomgroup}[1]{%
% \ifthenelse{\equal{#1}{L}}{\item[\textbf{Roman symbols}]}{%
% \ifthenelse{\equal{#1}{G}}{\item[\textbf{Greek symbols}]}{%
% \ifthenelse{\equal{#1}{A}}{\item[\textbf{Acronyms and Abbreviations}]}{%
% \ifthenelse{\equal{#1}{E}}{\item[\textbf{Exponents}]}{%
% \ifthenelse{\equal{#1}{I}}{\item[\textbf{Indices}]}{%
% \ifthenelse{\equal{#1}{O}}{\item[\textbf{Mathematical notations}]}
% {}
