...
\begin{table}[H]
	\begin{tabularx}{\linewidth}{p{4cm}cX}
		\toprule
		Criterion & is met & Description \\
		\midrule
		\textbf{Social Awareness} & {\Large $\hlgb{\checkmark}$} & using the ego-attention architecture to actively attend to other vehicles \\
		\textbf{Sample Efficiency} & {\Large $\hlgb{\checkmark}$} & social-awareness is an inductive bias which fastens training \\
