...
% TODO: \Qr^* must be replaced by \Qr[^*], same for Qc
...
\begin{proof}
   ...
   |\Qr(\os,\oa_1) - \Qr(\os,\oa_2)| \leq L|\Qc(\os,\oa_1) - \Qc(\os,\oa_2)|
    ...
    \begin{figure}[ht]
        ...
        \caption{We represent a section $[\budget-\epsilon, \budget+\epsilon]$ of $\cF^1$ and $\text{Ball}(\cF^1, R)$. We want to bound the range of $\Qr^{2*}.$}
