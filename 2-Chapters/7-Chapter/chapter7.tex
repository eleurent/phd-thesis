...
%TODO: review of our requirements
% Socially aware: check (coupled dynamics)
% Safety: check (worst-case)
% Balanced with efficiency: conservativeness can be tuned with confidence level $\delta$, or adding additional modelling assumptions which increases robustness at the price of efficiency.
% Sample efficient: based on optimistic planner, which can benefit from contributions of Chapter 6, value of merging the states
