...
This chapter provides an overview of sequential decision making in the specific context of Autonomous Driving. Not comprehensive, aims at breadth rather than depth. What have researchers been doing? What questions may a one practitioner ask when trying to apply RL for AD.
\minitocStartChapter{}
...
\TODO{Present the Several performance measures? return, cumulative regret, simple regret, PAC ? + fix next paragraph}
