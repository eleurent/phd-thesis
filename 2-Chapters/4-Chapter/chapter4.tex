...
\begin{figure}[htp]
	\centering
	\subfloat{
		\includegraphics[width=.6\linewidth]{img/total_reward}
	}\\
	\subfloat{
		\includegraphics[width=.6\linewidth]{img/length}
	}\\
	\subfloat{
		\includegraphics[width=.6\linewidth]{img/velocity}
	}
...
\begin{figure}[tp]
	\centering
	\subfloat{
		\includegraphics[width=.4\linewidth]{img/watch1}
	}
	\subfloat{
		\includegraphics[width=.4\linewidth]{img/watch2}
	}
...
\begin{figure}[htp]
	\centering
	\subfloat[]{
		\includegraphics[width=.48\linewidth]{img/priority1}
	}
	\subfloat[]{
		\includegraphics[width=.48\linewidth]{img/priority2}
	}
