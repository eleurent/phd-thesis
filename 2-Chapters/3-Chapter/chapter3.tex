...
Having discussed at length the range of \glsxtrlong{AD} modelling perspectives in \Cref{chapter:2}, we now formalize the specific problem that we are going to consider in this thesis. This chapter attempts to cast Behavioural Planning as a \glsxtrlong{MDP}, by specifying each element of a $(\cS, \cA, P, R, \gamma)$ tuple suitable for a set of tactical decision-making tasks.
\minitocStartChapter{}
