...
\begin{itemize}
	\item \bibentry{Leurent2020beyond} (used in \Cref{chapter:7})
	\item \bibentry{Leurent2020monte} (used in \Cref{chapter:6})
\end{itemize}

\subsubsection*{Software}

\begin{itemize}
	\item \bibentry{highway-env} (used in \Cref{chapter:3,chapter:4,chapter:5,chapter:6,chapter:7})
\end{itemize}
