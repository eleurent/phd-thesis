...
\newglossaryentry{timestep}{name={\var{\mathrm{d} t}},description={time step at which \gls{MPC} controls are applied},type=symbols, category=symbol}
\newcommand{\timestep}{\gls{timestep}}

\newglossaryentry{confidence}{name={\var{\delta}},description={confidence level for statistical estimates, in $(0, 1]$] },type=symbols, category=symbol}
\newcommand{\confidence}{{\gls{confidence}}}


\newglossaryentry{confidenceset}{name={\var{\mathcal{C}_{[N],\delta}}},description={high-confidence set for the estimation of $\params$, such that $\mathbb{P}(\params\in\confidenceset) \geq 1-\confidence$.},type=symbols, category=symbol}
