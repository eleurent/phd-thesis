...
% Class (remove "print" for digital version, remove "draft" for final version)
 \documentclass[a4paper,12pt,twoside,PageStyleII,authoryear,draft]{0-Misc/PhDThesisPSnPDF}
...
\supervisor{Odalric-Ambrym Maillard}
...
\begin{document}
	...
	\begin{spacing}{0.93}
		...
		\newcommand*{\Agroupname}{Mathematics}
