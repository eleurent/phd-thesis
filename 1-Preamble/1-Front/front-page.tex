...
{\Huge\centering\parbox[c][][t]{\paperwidth}
	...
	\normalsize et l'encadrement de \large \textbf{Denis Efimov}\\
	\normalsize ainsi que de \large \textbf{Yann Blanco}}
};
...
{\normalsize\centering\parbox[c][][t]{\paperwidth}
	{\centering
		...
		First \textbf{Last} & University & Président du jury \\
		First \textbf{Last} & University & Rapporteur \\
		First \textbf{Last} & University & Rapporteur \\
		...
		M. Denis \textbf{Efimov} & Université de Lille & Examinateur \\
