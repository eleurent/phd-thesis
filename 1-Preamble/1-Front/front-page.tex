...
\draw (page cs:0.,0.3) node [inner sep=1cm]
{\large\centering\parbox[c][][t]{\paperwidth}
	{\centering  \par\noindent\rule{0.9\textwidth}{0.4pt}\\
		{\LARGE\textsc{Safe and Efficient Reinforcement Learning}\\ \textsc{for Behavioural Planning in Autonomous Driving}}\\
		 \par\noindent\rule{0.9\textwidth}{0.4pt}\\
		 {\Large\textsc{Apprentissage par renforcement sûr et efficace}\\ \textsc{pour la prise de décision comportementale en conduite autonome}}\\
		 \par\noindent\rule{0.9\textwidth}{0.4pt}
}};

\draw (page cs:0.,0.0) node [text opacity=1,inner sep=1cm]
...
\draw (page cs:0.,-0.2) node [text opacity=1,inner sep=1cm]
{
	\normalsize\centering
...
\draw (page cs:0.,-0.4) node [text opacity=1,inner sep=1cm]
{\normalsize\centering\parbox[c][][t]{\paperwidth}
	{\centering
		...
		M\textsuperscript{me} Luce \textbf{Brotcorne} & Inria & Présidente \\
		M. Marc \textbf{Deisenroth} & University College London & Examinateur \\
		M. Denis \textbf{Efimov} & Inria & Encadrant \\
		M. Odalric-Ambrym \textbf{Maillard} & Inria & Directeur de thèse \\
